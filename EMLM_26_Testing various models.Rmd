...
# Model 1: Base Model 
model1 <- lme(UPDRS ~ Visit * smoking_status + Age + sex,
                   random = ~Visit | id,
                   data = DF,
                   method = "ML",
                   na.action = na.exclude)

# Model 2: Variance weights added
model2 <- lme(UPDRS ~ Visit * smoking_status + Age + sex,
                          random = ~Visit | id,
                          data = DF,
                          method = "ML",
                          na.action = na.exclude,
...
# Model 3: Natural spline for time added
model3 <- lme(UPDRS ~ ns(Visit, df = 3) + smoking_status + 
                            ns(Visit, df = 3):smoking_status + Age + sex,
                          random = ~Visit | id,
                          data = DF,
                          method = "ML",
                          na.action = na.exclude)

# Model 4: Both natural spline and variance weights added
model4 <- lme(UPDRS ~ ns(Visit, df = 3) + smoking_status + 
                                ns(Visit, df = 3):smoking_status + Age + sex,
                              random = ~Visit | id,
                              data = DF,
                              method = "ML",
...
# Model 5: Quadratic time effect added
model5 <- lme(UPDRS ~ Visit + I(Visit^2) + smoking_status + 
...
# Model 6: Both variance weights and quadratic time effect added
model6 <- lme(UPDRS ~ Visit + I(Visit^2) + smoking_status + 
                          Visit:smoking_status + Age + sex,
                        random = ~Visit | id,
                        data = DF,
                        method = "ML",
